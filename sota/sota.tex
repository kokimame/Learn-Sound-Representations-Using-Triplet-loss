...
%	\caption{Clustering audio data allows for more efficient search. For this purpose, it is required to measure similarity between audio data in a complex space and efficient algorithm for clustering}
...
events or “acoustic objects” which we have never encountered before, based on how that phenomenon stands out against the background [1]
